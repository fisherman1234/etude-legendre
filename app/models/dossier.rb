class Dossier < ActiveRecord::Base
  ...
  validates_presence_of :user_id, :institution_id, :type_expertise_id, :parametres_cabinet_id, :ref_cabinet, :nom_dossier, :date_avis_designation, :date_cible_depot_rapport
