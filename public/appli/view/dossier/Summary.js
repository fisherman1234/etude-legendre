Ext.define('TP.view.dossier.Summary', {
    ...
    tplMarkupExport: ['<h1>Export :</h1><a href=/export/contacts?id={id}>Exporter la liste des contacts</a><br/>', '<a href=/export/documents?id={id}>Exporter la liste des documents</a><br/><a href=/export/expenses?id={id}>Exporter la liste des dépenses</a>'],
