Ext.define('TP.view.dossier.Summary', {
    ...
    tplMarkupExport: ['<h1>Export :</h1><a href=/export/contacts?id={id}>Exporter la liste des contacts</a><br/>', '<a href=/export/convocations?id={id}>Exporter la liste des convocations</a><br/>', '<a href=/export/list_pieces?id={id}>Exporter la liste des pièces par avocats</a><br/><a href=/export/documents?id={id}>Exporter la liste des documents</a><br/><a href=/export/expenses?id={id}>Exporter la liste des dépenses</a>','<br/><br/><a href="javascript: if (confirm(\'Confirmer la suppression ?\')) { window.location.href=\'/dossiers/{id}/destroy\' } else { void(\'\') };">Supprimer ce dossier</a>'],
