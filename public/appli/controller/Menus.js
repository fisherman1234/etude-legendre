Ext.define('TP.controller.Menus', {
    ...
    views: ['menu.TypeActivites', 'menu.Main', 'menu.Settings', 'menu.SettingsList', 'menu.Categories', 'menu.Items', 'menu.QualiteProcedurales', 'menu.TauxTvas', 'menu.Unites', 'menu.TypeDecisions', 'menu.TypeEtatDossiers', 'menu.TypeExpertises', 'menu.TypeInstitutions', 'menu.TypeIntervenants', 'TP.view.user.UserList', 'TP.view.user.UserForm', 'TP.view.user.NewUserForm','TP.view.user.EditUser', 'TP.view.user.NewUser','TP.view.messagetemplate.Edit'],
